              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center mb-2">
                    <img src="<?= base_url('assets/img/profile/M-KAS.png'); ?>" height="150px" width="150px">
                  ...
                  <div class="text-center">
                    <a class="text-gray-400">Tidak punya akun? Silahkan</a>
                    <a class="small-400" href="<?= base_url(); ?>auth/register">Link Ini</a>
                  </div>
                </div>
              </div>
            </div>
